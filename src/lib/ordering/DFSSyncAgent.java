...
public abstract class DFSSyncAgent extends SyncAgent{
    ...
    private static final int MSG_DFS_HEIGHT = 0XFFFF4;
...
//    protected List<Integer> pseudochildren;
    ...
    protected Map<Integer,Integer> SubHeight;//我加滴
...
//                System.out.println(message);
            ...
            case MSG_DFS_HEIGHT://我加滴
                SubHeight.put(message.getIdSender(), (int)message.getValue());//我加滴
                break;
            case MSG_DFS_BACKTRACK:
                BacktrackMessageContent content = (BacktrackMessageContent) message.getValue();
                visited = content.visited;
                SubHeight.put(message.getIdSender(), content.height);//我加滴
                ...
                if (selectedChild != 0){
                    ...
                    if (id != 1) {
                        ...
                        for (int pp : pseudoParents) {
                            sendMessage(new Message(id, pp, MSG_DFS_HEIGHT,height ));//我加滴
                        }
