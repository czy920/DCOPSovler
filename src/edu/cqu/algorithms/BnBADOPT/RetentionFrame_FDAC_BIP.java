...
public abstract class RetentionFrame_FDAC_BIP extends FDAC_BIP {
    ...
    public RetentionFrame_FDAC_BIP(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
    ...
    @Override
    protected void SynchronousAlgorithmStart() {
