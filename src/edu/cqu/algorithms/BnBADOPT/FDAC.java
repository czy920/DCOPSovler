...
public abstract class FDAC extends DFSSyncAgent {
...
//    protected List<Map.Entry<Integer,Integer>> DomainTraverOrder;
    ...
    public FDAC(int id, int[] domain, int[] neighbours, Map<Integer, int[][]> constraintCosts, Map<Integer, int[]> neighbourDomains, SyncMailer mailer) {
        super(id, domain, neighbours, constraintCosts, neighbourDomains, mailer);
    }
    protected abstract void AlgorithmStart();//abstract
    @Override
    protected void pseudoTreeCreated() {
        ...
        Dom=new ArrayList<>();
      //  DomainTraverOrder= InitialTraverOrder();
        branch=new HashMap<>();
...
//    private  List<Map.Entry<Integer,Integer>> InitialTraverOrder()
//    {
//        Map<Integer,Integer> ValueCnt=new HashMap<>();
//        for(int i=0;i<domain.length;i++) {
//            ValueCnt.put(i,i);
//        }
//        List<Map.Entry<Integer,Integer>> TraverOrder= new ArrayList<>(ValueCnt.entrySet());
//        return TraverOrder;
//    }
